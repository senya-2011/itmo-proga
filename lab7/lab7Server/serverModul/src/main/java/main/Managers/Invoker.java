...
import main.threads.CommandTask;
...
public class Invoker {
    ...
    public Invoker(CollectionManager cm){
        ...
        commands.put("login", new LoginCommand(cm));
        commands.put("my", new MyCommand(cm));
    }
    ...
    private void checkArg(Request request){
        ...
        collectionManager.setPassword(request.getPassword());
